...
public class Lab099 {
    public static void main(String[] args) {
        ...
        System.out.println(marks_10[4]); //Exception in thread out of bounds
        ...
        a[1]=98;
        a[0]=89; // We can change any time


        final int[] b = new int[4]; // We have final only for length not value
        //b === > [ 0 ,0,0,0]  - default value of int  is 0
        b[0]=78;
        System.out.println(b[0]); // value can be change
